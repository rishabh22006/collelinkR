  ...
  return (
    ...
    >
      <div className="p-5 flex flex-col items-center text-center">
        ...
        <h3 className="font-medium text-lg mb-2 text-foreground">Get Your Club Listed</h3>
        <p className="text-sm text-muted-foreground mb-4">Register your university club and connect with students</p>
        <Button 
          variant="default" 
          size="sm"
